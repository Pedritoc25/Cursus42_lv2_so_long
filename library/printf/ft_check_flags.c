...
/*   Updated: 2024/09/30 12:29:38 by pcabanas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_check_flags(const char flag, va_list ptr)
{
	...
	count = 0;
	if (flag == 'c')
		count += ft_putchar_printf(va_arg(ptr, int));
	if (flag == 's')
		count += ft_putstr_printf(va_arg(ptr, char *));
	if (flag == 'p')
	{
		count += write (1, "0x", 2);
	...
	if (flag == 'i' || flag == 'd')
		count += ft_putnbr_printf(va_arg(ptr, int));
	if (flag == 'u')
